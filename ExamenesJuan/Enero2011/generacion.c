...
void escribir_subseccion_data(FILE* fpasm){
        ...
        fprintf(fpasm, "\tmensaje_3 db \"Potencia menor que 0\",10,0\n");
}
...
void escribir_fin(FILE* fpasm){
        ...
        fprintf(fpasm, "error_3:\n");
        fprintf(fpasm, "\tpush dword mensaje_3\n");
        fprintf(fpasm, "\tcall print_string\n");
        fprintf(fpasm, "\tadd esp, 4\n");
        fprintf(fpasm, "\tjmp fin\n");
...
void potencia(FILE* fpasm, int es_variable_1, int es_variable_2,int etiqueta){
        ...
        fprintf(fpasm, "\tjle error_3\n");
        fprintf(fpasm, "\tmov ecx, eax\n");
        fprintf(fpasm, "potencia_%d:\n",etiqueta);
        fprintf(fpasm, "\tcmp ebx, 1\n");
        fprintf(fpasm, "\tje finPotencia_%d\n",etiqueta);
        fprintf(fpasm, "\timul ecx\n");
        fprintf(fpasm, "\tadd ebx, -1\n");
        fprintf(fpasm, "\tjmp potencia_%d\n",etiqueta);
        /* Guardamos el valor  la pila*/
